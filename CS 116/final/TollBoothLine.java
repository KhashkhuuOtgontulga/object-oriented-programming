...
public class TollBoothLine {
	...
	public void setLineLength(int length) {
		try { if (length>=0) numOfVehicles = length; else throw new InputMismatchException();}
		catch (InputMismatchException e) { System.out.println("Incorrect Line Length assigned. Line will be set to previous value.");}
	}
	*/
	...
	/*	add vehicle to line method (call getLineLength(); 
		inside method & reassign the max line length reached 
